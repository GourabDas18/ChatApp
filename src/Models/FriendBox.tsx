    ...
    return (
        <div className='fixed top-[100dvh] min-h-[60%] max-h-[85%] w-[25vw] md:w-[75vw] flex flex-col items-center shadow-lg bg-[#ffffffb0] md:backdrop-blur-md md:bg-[#ffffffb2] dark:bg-[#1e1a2fbd] md:shadow-lg md:rounded-lg md:p-4 z-[100]' ref={friendElement}>
            ...
            <div className="flex flex-row items-center py-2">
                <input type="text" placeholder="Search Friends" className=" pl-[2vw] md:pl-8 w-full border-none focus:outline-none rounded-md h-[2vw] md:h-10 bg-white dark:bg-slate-400 dark:text-slate-950 text-[0.8vw] md:text-xs text-gray-800" defaultValue={inputValue} onChange={(e)=>{setInputValue(e.currentTarget.value)}}/>
