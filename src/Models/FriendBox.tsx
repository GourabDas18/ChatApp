...
const FriendBox = ({ setaddFriendShow }: FriendBoxType) => {
    ...
    return (
        <div className='fixed top-[100dvh] min-h-[60%] max-h-[85%] w-[25vw] md:w-[75vw] flex flex-col items-center shadow-lg bg-[#ffffffb0] md:backdrop-blur-md md:bg-[#ffffffb2] md:shadow-lg md:rounded-lg md:p-4 z-[100]' ref={friendElement}>
            ...
            <div className="flex flex-row items-center">
                ...
                <i className="fi fi-sr-woman-head absolute left-[0.3vw] md:left-2 text-gray-600 mt-1"></i>
            </div>
            <hr className=" my-2 w-full border-b-2 border-pink-300" />
            {filteredshowingUser !== null && filteredshowingUser.map((each: eachUserType) => {
                return <div className="flex flex-row items-center px-4 py-3 bg-white my-[0.5vw] w-full rounded-lg">
