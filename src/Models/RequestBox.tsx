    ...
    return (
        <div className='fixed top-[100dvh] min-h-[60%] max-h-[85%] w-[25vw] md:w-[75vw] flex flex-col items-center shadow-lg bg-[#ffffffb0] md:backdrop-blur-md md:bg-[#ffffffb2] md:shadow-lg md:rounded-lg p-5' ref={friendElement}>
            ...
            <div className="flex flex-row items-center">
                <input type="text" placeholder="Search Friends" className=" pl-[2vw] md:pl-8  w-full border-none focus:outline-none rounded-md h-[2vw] md:h-10 md:w-52 md:text-xs bg-white text-[0.75vw] text-gray-600" />
                <i className="fi fi-sr-woman-head absolute left-[0.5vw] md:left-2 text-gray-600 mt-1"></i>
            </div>
