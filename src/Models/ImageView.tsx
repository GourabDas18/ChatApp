...
const ImageView = ({ setImageShow, src }: ImageViewType) => {
    ...
    return (
        <div className='fixed z-10 top-[100dvh] min-h-[60%] max-h-[85%] w-[25vw] md:w-[90vw] overflow-hidden flex flex-col items-center justify-center shadow-lg bg-[#ffffffb0] md:backdrop-blur-md md:bg-[#ffffffb2] md:shadow-lg md:rounded-lg md:p-4' ref={ImageElement}>
